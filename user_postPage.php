...
try {
    ...
    $sql = 'SELECT userID, postID FROM user_post';
    $q = $pdo->query($sql);
...
break;
            ...
            <br><br><h2>Current List of User Posts</h2>
                ...
                <tbody>
                    <?php while ($row = $q->fetch()): ?>
                        <tr>
                            ...
                            <td><?php echo '<form action="/UPdelete.php" method="post"><input type="submit" value="DELETE"><input type="hidden" name="userID" value="' . htmlspecialchars($row['userID']) . '"></form>'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <br><h2>Insert a new user post:</h2>
		...
		<br><h2>Update user post information:</h2>
		<form action="/UPupdate.php" method="post">
			<table>
				<tr><td>User ID:</td><td><input type="text" id="userID" name="userID" value=""></td></tr>
				<tr><td>Post ID:</td><td><input type="text" id="postID" name="postID" value=""></td></tr>
			</table>

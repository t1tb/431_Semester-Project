...
try {
    ...
    $sql = 'SELECT replyID, userID, postID, reply_text FROM reply';
    $q = $pdo->query($sql);
...
break;
            ...
            <br><br><h2>Current List of Replies</h2>
                ...
                <tbody>
                    <?php while ($row = $q->fetch()): ?>
                        <tr>
                            ...
                            <td><?php echo '<form action="/replydelete.php" method="post"><input type="submit" value="DELETE"><input type="hidden" name="reply_text" value="' . htmlspecialchars($row['reply_text']) . '"></form>'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <br><h2>Insert a new reply:</h2>
        <form action="/replyinsert.php" method="post">
            <table>
                ...
                <tr><td>Reply text:</td><td><input type="text" id="reply_text" name="reply_text" value=""></td></tr>
            </table>
            <br><input type="submit" value="INSERT">
        </form>
        <br><h2>Update reply information:</h2>

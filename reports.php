...
<html>
    ...
    <body>
        ...
        <div id="container">
        <br><br><h3>Click below to navigate to the Users page</h3>
                <?php echo '<form action="/start.php" method="post"><input type="submit" value="Users"></form>'; ?>
            <br>
   ...
   <br><h2>5) The number of likes on each reply from a given user</h2>

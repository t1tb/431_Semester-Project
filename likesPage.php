...
try {
    ...
    $sql = 'SELECT likeID, userID, replyID FROM likes';
    $q = $pdo->query($sql);
...
break;
            ...
            <br><br><h2>Current List of Likes</h2>
            <table border=1 cellspacing=5 cellpadding=5>
                ...
                <tbody>
                    <?php while ($row = $q->fetch()): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($row['likeID']) ?></td>
                            <td><?php echo htmlspecialchars($row['userID']); ?></td>
                            <td><?php echo htmlspecialchars($row['replyID']); ?></td>
                            <td><?php echo '<form action="/likesdelete.php" method="post"><input type="submit" value="DELETE"><input type="hidden" name="replyID" value="' . htmlspecialchars($row['replyID']) . '"></form>'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <br><h2>Insert a new like:</h2>
        <form action="/likesinsert.php" method="post">
            <table>
                <tr><td>Like ID:</td><td><input type="text" id="likeID" name="likeID" value=""></td></tr>
        ...
        <br><h2>Update like information:</h2>
        <form action="/likesupdate.php" method="post">
            <table>
                <tr><td>Like ID:</td><td><input type="text" id="likeID" name="likeID" value=""></td></tr>
                <tr><td>User ID:</td><td><input type="text" id="userID" name="userID" value=""></td></tr>
                <tr><td>Reply ID:</td><td><input type="text" id="replyID" name="replyID" value=""></td></tr>  

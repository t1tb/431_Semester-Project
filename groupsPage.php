...
try {
    ...
    $sql = 'SELECT groupID, userID FROM groups';
    $q = $pdo->query($sql);
...
break;
            ...
            <br><br><h2>Current List of Groups</h2>
                ...
                <tbody>
                    <?php while ($row = $q->fetch()): ?>
                        <tr>
                            ...
                            <td><?php echo '<form action="/groupdelete.php" method="post"><input type="submit" value="DELETE"><input type="hidden" name="userID" value="' . htmlspecialchars($row['userID']) . '"></form>'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <br><h2>Insert a new group:</h2>
        ...
        <br><h2>Update group information:</h2>

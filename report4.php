...
try {
    ...
    $sql = 'SELECT friendID, first_name, last_name, email FROM friend F, user U WHERE F.friendID = U.userID AND F.userID = "' . $_POST["userID"] . '"  ';
    $q = $pdo->query($sql);
...
<br><br>
<h2><?php echo "User " . $_POST["userID"] . "'s List of Friends"; 
?></h2>
    <div align = 'center'>

...
try {
    ...
    $sql = 'SELECT commentID, userID, replyID, comment_text FROM comment';
    $q = $pdo->query($sql);
...
break;
            ...
            <br><br><h2>Current List of Comments</h2>
                ...
                <tbody>
                    <?php while ($row = $q->fetch()): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row['replyID']) ?></td>
                            <td><?php echo htmlspecialchars($row['comment_text']); ?></td>
                           
                            <td><?php echo '<form action="/commentdelete.php" method="post"><input type="submit" value="DELETE"><input type="hidden" name="comment_text" value="' . htmlspecialchars($row['comment_text']) . '"></form>'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <br><h2>Insert a new comment:</h2>
        <form action="/commentinsert.php" method="post">
            <table>
                <tr><td>Comment ID:</td><td><input type="text" id="commentID" name="commentID" value=""></td></tr>
                <tr><td>User ID:</td><td><input type="text" id="userID" name="userID" value=""></td></tr>
                <tr><td>Reply ID:</td><td><input type="text" id="replyID" name="replyID" value=""></td></tr>
                <tr><td>Romment text:</td><td><input type="text" id="comment_text" name="comment_text" value=""></td></tr>
            </table>
            <br><input type="submit" value="INSERT">
        </form>
        <br><h2>Update comment information:</h2>
        <form action="/commentupdate.php" method="post">
            <table>
                <tr><td>Comment ID:</td><td><input type="text" id="commentId" name="commentID" value=""></td></tr>
                <tr><td>User ID:</td><td><input type="text" id="userID" name="userID" value=""></td></tr>
                <tr><td>Reply ID:</td><td><input type="text" id="replyID" name="replyID" value=""></td></tr>
                <tr><td>Comment text:</td><td><input type="text" id="comment_text" name="comment_text" value=""></td></tr>
            </table>

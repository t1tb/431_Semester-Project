...
try {
    ...
    $sql = 'SELECT G.groupID, UG.name FROM groups as G, user_groups as UG, user as U WHERE G.userID = U.userID AND G.groupID = UG.groupID AND U.userID = "' . $_SESSION["userID"] . '"  ';
    $q = $pdo->query($sql);
